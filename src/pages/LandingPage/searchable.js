        ...
        <>
          ...
          <li className="home-autocomplete-field">
            ...
            <li className="col-2 px-0">
              <SelectSearch  options={countryOptions} setValue={setCountry} label="Select Country" value={country}/>
            </li>
            <li className="col-1 px-0">
              <SelectSearch options={minPriceOptions} setValue={setMinPrice} label="Select Min Price "  value={minPrice}/>
            </li>
            <li className="col-1 px-0">
              <SelectSearch options={maxPriceOptions} setValue={setMaxPrice} label="Select Max Price"  value={maxPrice}/>
            </li>
            <li>
