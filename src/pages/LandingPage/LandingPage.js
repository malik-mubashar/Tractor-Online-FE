    ...
    <div className="overflow-x-hidden">
      ...
      <div className="container-lg py-4">
        <FeaturedProducts
          ...
          link="View all managed by TractorOnline"
        />
      </div>
      <div className="bg-white">
        <div className="container-lg py-4">
          <FeaturedProducts
            title="Featured Used Tractor For Sale"
            link="View all featured used tractors"
          />
        </div>
      </div>
      ...
      <div className="container-lg py-4 mt-2">
        <FeaturedNewTractor
          title="Featured New Tractors"
          link="view all tractors"
        />
      </div>
      <div className="container-lg py-4">
        <NewCarByMake />
